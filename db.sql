...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2021 a las 01:19:41
...
(34, 41, 55, 18, 14, 2, 12, '2021-10-22 01:10:16', 1, 1),
(35, 41, 56, 8, 19, 4, 5, '2021-10-22 01:10:16', 2, 1),
(36, 41, 57, 9, 6, 1, 17, '2021-10-22 01:10:17', 3, 1),
(37, 41, 58, 7, 10, 16, 11, '2021-10-22 01:10:17', 4, 1);
...
--
ALTER TABLE `jugadores`
  MODIFY `id_jugador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT de la tabla `partidas`
--
ALTER TABLE `partidas`
  MODIFY `id_partida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `partidas_secreto`
  MODIFY `id_partida_secreto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT de la tabla `rel_partida_jugador_cartas`
--
ALTER TABLE `rel_partida_jugador_cartas`
  MODIFY `id_partida_jugador_cartas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT de la tabla `rel_partida_jugador_tablas`
--
ALTER TABLE `rel_partida_jugador_tablas`
  MODIFY `id_partida_jugador_carta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7457;
